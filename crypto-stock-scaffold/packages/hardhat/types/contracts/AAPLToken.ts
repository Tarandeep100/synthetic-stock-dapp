...
export interface AAPLTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface AAPLToken extends BaseContract {
  connect(runner?: ContractRunner | null): AAPLToken;
  waitForDeployment(): Promise<this>;

  interface: AAPLTokenInterface;
  ...
  filters: {
    ...
    "Burn(address,uint256,address)": TypedContractEvent<
      BurnEvent.InputTuple,
      BurnEvent.OutputTuple,
      BurnEvent.OutputObject
    >;
    ...
    "Mint(address,uint256,address)": TypedContractEvent<
      MintEvent.InputTuple,
      MintEvent.OutputTuple,
      MintEvent.OutputObject
    >;
